    ...
    <section className='bg-gradient-to-r  from-blue-600 to-purple-600 text-white py-16'>
        <div className='max-w-7xl mx-auto  px-4'>
            <div className='grid md:grid-cols-2 gap-8 items-center'>
                <div className='m-5'>
                    <h1 className='text-4xl md:text-6xl font-bold mb-4'>Latest Electronic at Best Prices</h1>
                ...
                <div className='relative'>
                    <div className='mb-15'>
                        <img src="/ekart-hero1.png" alt="" width={450} height={150} className='rounded-lg drop-shadow-2xl'/>
                    </div>
