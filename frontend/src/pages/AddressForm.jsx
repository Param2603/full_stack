                    ...
                    showForm ? (
                        <>
                          ...
                          <div>
                            ...
                            <Input id="phone" name="phone" required placeholder="+91 1234567890"
                               value={formData.phone} onChange={handleChange}/>
                          </div>

                          <div>
                            <Label htmlFor="email">Email</Label>
                            <Input id="email" name="email" required placeholder="John@example.cpm"
                               value={formData.email} onChange={handleChange}/>
                          </div>

                          <div>
                            <Label htmlFor="address">Address</Label>
                            <Input id="address" name="address" required placeholder="123 Street Area"
                          ...
                          <div>
                            ...
                            <Input id="state" name="state" required placeholder="West Bengal"
                          ...
                          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                            ...
                            <Input id="zip" name="zip" required placeholder="70010"
