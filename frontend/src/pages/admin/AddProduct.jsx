...
const submitHandle = async(e) => {
  ...
  try {
    setLoading(true)
    const res = await axios.post(`http://localhost:8080/api/v1/product/add`, formData, {
      headers: {
        ...
        <CardContent>
          <div className='flex flex-col gap-2'>
            <div className='grid gap-2'>
              ...
              <Input type='text' value={productData.productName} onChange={handleChange} name="productName" placeholder="Ex-Iphone" required/>
            </div>  
            ...
            <div className='grid grid-cols-2 gap-4'>
              <div className='grid gap-2'>
                <Label>Brand</Label>
                <Input type='text' value={productData.brand} onChange={handleChange} name="brand" placeholder="Ex-apple" required/>
              </div>

              <div className='grid gap-2'>
                <Label>Category</Label>
                <Input type='text' value={productData.category} onChange={handleChange} name="category" placeholder="Ex-mobile" required/>
              </div>
            </div> 
          ...
          <CardFooter className="flex-col gap-2">
            <Button disabled={loading} onClick={submitHandle} className="w-full bg-pink-600 mt-6 cursor-pointer" type="submit">
              {
